...
class GameLevelWater {
  constructor(gameEnv) {
    ...
    const sprite_data_dolphin = {
        id: 'Dolphin',
        name: 'mainplayer',
        greeting: "Hi I am Dolphin, the coolest mammal in the sea. I am looking for wisdom and adventure!",
        src: sprite_src_dolphin,
        SCALE_FACTOR: DOLPHIN_SCALE_FACTOR,
        STEP_FACTOR: 1000,
        ANIMATION_RATE: 50,
        GRAVITY: true,
        INIT_POSITION: { x: 0, y: height - (height/DOLPHIN_SCALE_FACTOR) },
